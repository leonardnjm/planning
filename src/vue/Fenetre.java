...
//        listeDeTables.addItemListener(this);
 //       listeDeRequetes.addItemListener(this);
  ...
  //      p1.setBackground(Color.LIGHT_GRAY);
    ...
    public Fenetre(Utilisateur z,int s) {
        // creation par heritage de la fenetre
        super("Hyperplanning");
...
//        listeDeTables.addItemListener(this);
 //       listeDeRequetes.addItemListener(this);
  ...
  //      p1.setBackground(Color.LIGHT_GRAY);
    ...
    public Fenetre(Utilisateur z,int s,String pro) {
        // creation par heritage de la fenetre
        super("Hyperplanning");
...
//        listeDeTables.addItemListener(this);
 //       listeDeRequetes.addItemListener(this);
  ...
  //      p1.setBackground(Color.LIGHT_GRAY);
        ...
        add("Center", p2);
      // Planning a= new Planning(z,23);
       Planning b=new Planning(z,s,pro);
       //a.setOpaque(true);
